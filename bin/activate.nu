...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/pandora/Documents/deep/DeepFaceLab_MacOS/.dfl/env'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/pandora/Documents/deep/DeepFaceLab_MacOS/.dfl/env/bin/deactivate.nu'
